...
public class DataAbsen extends javax.swing.JFrame {
    ...
    private void table(){
        ...
        try{
            ResultSet res = stat.executeQuery("SELECT * FROM rekap_absen LEFT JOIN karyawan ON rekap_absen.kode_karyawan = karyawan.kode_karyawan LEFT JOIN jadwal ON karyawan.id_jadwal = jadwal.id_jadwal ORDER BY tanggal_absen DESC");
            while(res.next())
            {
    ...
    private void cariData(String key){
        ...
        try{
            ResultSet res = stat.executeQuery("SELECT * FROM rekap_absen LEFT JOIN karyawan ON rekap_absen.kode_karyawan = karyawan.kode_karyawan LEFT JOIN jadwal ON karyawan.id_jadwal = jadwal.id_jadwal WHERE tanggal_absen LIKE '%"+key+"%'");
            while(res.next())
            {
               tb.addRow(new Object[]{
                   res.getString("nama_karyawan"),
    ...
    private void initComponents() {
        ...
        absenTB = new javax.swing.JTable();
        ...
        cariDate = new com.toedter.calendar.JDateChooser();
        ...
        absenTB.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "NAMA KARYAWAN", "TANGGAL PRESENSI", "JAM MASUK", "JAM KELUAR", "SHIFT", "KETERANGAN"
            }
        ));
        jScrollPane1.setViewportView(absenTB);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel1.setText("REKAP ABSEN");
        ...
        jLabel6.setText("TAMPILKAN DATA PER TANGGAL");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(cariDate, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(jLabel6)
                                .addComponent(cariDate, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(5, 5, 5)))
                .addContainerGap())
        );
    ...
    private void kelolaBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kelolaBTNActionPerformed
        // TODO add your handling code here:
        GUI.admin.KelolaAbsen kk = new GUI.admin.KelolaAbsen();
        kk.setVisible(true);
        dispose();
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        String key = String.valueOf(fm.format(cariDate.getDate()));
    ...
    private javax.swing.JTable absenTB;
    private com.toedter.calendar.JDateChooser cariDate;
