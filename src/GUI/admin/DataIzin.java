 ...
 * @author akmal
 */
public class DataIzin extends javax.swing.JFrame {
    ...
    /**
     * Creates new form perizinanKaryawan
     */
    public DataIzin() {
        initComponents();
        koneksiDB();
    ...
    private void table(){
        ...
        tb.addColumn("Memohon");
        tb.addColumn("Dari Tanggal");
        tb.addColumn("Sampai Tanggal");
        tb.addColumn("Keterangan");
        izinTB.setModel(tb);
        
        try{
            ResultSet res = stat.executeQuery("SELECT * FROM izin LEFT JOIN karyawan ON karyawan.kode_karyawan = izin.kode_karyawan ORDER BY id_izin DESC");
            int serialNumber = 1; 
    ...
    private void cariData(String key){
        ...
        try{
            ResultSet res = stat.executeQuery("SELECT * FROM izin LEFT JOIN karyawan ON karyawan.kode_karyawan = izin.kode_karyawan WHERE nama_karyawan LIKE '%"+key+"%'");
            int serialNumber = 1; 
    ...
    private void initComponents() {
        ...
        izinTB.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "NO", "NAMA KARYAWAN", "IZIN", "DARI TANGGAL", "SAMPAI TANGGAL", "KETERANGAN"
            }
        ));
        jScrollPane1.setViewportView(izinTB);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel1.setText("DATA PERIZINAN");
        ...
        jLabel6.setText("Cari Data Izin");
    ...
    private void kelolaBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kelolaBTNActionPerformed
        // TODO add your handling code here:
        GUI.admin.KelolaPerizinan kk = new GUI.admin.KelolaPerizinan();
        kk.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataIzin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable izinTB;
